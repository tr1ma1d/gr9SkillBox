...
namespace vinLib
{
    internal class LibVin
    {
        /* https://github.com/Ethosa/VIN_App/tree/master
           вся библеотека разработана этим человеком, сам не догадался `_` -> :D
           Заранее автору спасибо, полностью код, постараюсь не п№"№"ть
        */
